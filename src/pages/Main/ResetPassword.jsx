  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background p-4 w-screen overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <Link
          to="/login"
          className="inline-flex items-center fixed top-8 left-8 text-muted-foreground hover:text-white transition-colors group z-10"
        >
          ...
          <CardContent>
            {invalidToken ? (
              <div className="flex flex-col items-center gap-4 py-4 text-center">
                ...
                <Link to="/forgot-password" className="text-primary hover:text-primary transition-colors text-sm font-medium">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="p-2 absolute right-3 top-1/2 -translate-y-1/2 bg-secondary/60 text-slate-200 hover:text-white hover:bg-secondary/60 rounded transition-colors"
                    >
          ...
          {!invalidToken && !success && (
            <CardFooter className="flex justify-center pt-2 pb-6">
              <div className="flex gap-1 text-sm items-center">
                <span className="text-muted-foreground">¿El enlace no funciona?</span>
                <Link to="/forgot-password" className="text-primary hover:text-primary transition-colors font-medium ml-1">
                  Solicitá uno nuevo
                </Link>
              </div>
            </CardFooter>
