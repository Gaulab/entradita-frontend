    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 p-4 w-screen">
      ...
      <Card className="w-full max-w-md bg-gray-800 border-gray-700">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center text-gray-400">Ingrese sus credenciales para acceder a la cuenta</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="password" type="password" name="password" required className="bg-gray-700 border-gray-600 text-white" />
            </div>
