          ...
          <CardContent>
            {submitted ? (
              <div className="flex flex-col items-center gap-4 py-4 text-center">
                ...
                <p className="text-muted-foreground text-xs">Revisá también tu carpeta de spam.</p>
              </div>
            ) : (
          ...
          {!submitted && (
            <CardFooter className="flex justify-center pt-2 pb-6">
              <div className="flex gap-1 text-sm items-center">
                <span className="text-muted-foreground">¿Recordaste la contraseña?</span>
                <Link to="/login" className="text-primary hover:text-primary transition-colors font-medium ml-1">
                  Iniciá sesión
                </Link>
              </div>
            </CardFooter>
