...
const TIER_DECORATION = {
  small:  { color: 'bg-primary',   icon: <Star className="w-5 h-5 sm:w-6 sm:h-6" />, description: 'Perfecto para eventos íntimos y exclusivos' },
...
export default function ModernPricing() {
  ...
  const handleChoosePlan = (tier) => {
    ...
    const whatsappUrl = `https://wa.me/5493482275737?text=${encodeURIComponent(message)}`;
    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <header className="backdrop-blur-md bg-background/80 border-b border-border/50 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3 sm:py-4 flex justify-between items-center">
          ...
          <Link to="/">
            <Button variant="entraditaTertiary" className="border-border text-muted-foreground hover:bg-card/50 hover:text-white backdrop-blur-sm text-sm sm:text-base">
      ...
      <main className="flex-grow container mx-auto px-4 py-6 sm:py-12">
        ...
        <section className="text-center mb-8 sm:mb-16">
          <div className="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-primary/20 mb-4 sm:mb-8 backdrop-blur-sm">
            <Sparkles className="h-3 w-3 sm:h-4 sm:w-4 text-primary mr-2" />
            <span className="text-xs sm:text-sm text-primary">Precios que se adaptan a tu éxito</span>
          </div>
        ...
        <section className="mb-8 sm:mb-16">
          <Card className="backdrop-blur-md bg-card/40 border-border/50 p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
            <CardHeader className="text-center pb-4 sm:pb-6 p-0 sm:p-0">
              <div className="flex justify-center items-center mb-3 sm:mb-4">
                <div className="p-2 sm:p-3 rounded-full bg-gradient-to-r from-blue-500/20 to-blue-500/20 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm sm:text-base">Desliza para ver cómo cambian los precios según la cantidad de tickets</p>
            </CardHeader>
            ...
            <CardContent className="space-y-6 sm:space-y-8 p-0">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-muted-foreground font-medium text-sm sm:text-base">Cantidad de tickets:</span>
              ...
              {currentTier && (
                <div className="text-center p-4 sm:p-6 rounded-xl bg-gradient-to-r from-slate-800/50 to-slate-700/50 border border-border/50">
                  <div className="flex justify-center items-center mb-3 sm:mb-4">
                  ...
                  <p className="text-muted-foreground mb-2 text-sm sm:text-base">{currentTier.description}</p>

                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-1 sm:gap-4 text-center">
                    <div>
                      <p className="text-xs sm:text-sm text-muted-foreground">Por ticket</p>
                    ...
                    <div>
                      <p className="text-xs sm:text-sm text-muted-foreground">Ahorras</p>
                      <p className="text-lg sm:text-2xl font-bold text-primary">${savings.toLocaleString()}</p>
                    </div>
                  </div>

                  <Button
                    onClick={() => handleChoosePlan(currentTier)}
                    className="mt-4 sm:mt-6 w-full sm:w-auto bg-primary text-white border-0 px-6 sm:px-8 py-2 sm:py-3"
                  >
                    Elegir plan
        ...
        <section className="mb-8 sm:mb-16">
          ...
          <div className="grid gap-4 sm:gap-6 lg:gap-8 md:grid-cols-3">
            {pricingTiers.map((tier, index) => (
              <Card
                key={index}
                className={`backdrop-blur-md bg-card/40 border-border/50 hover:bg-card/60 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/10 ${
                  tier.popular ? 'ring-2 ring-ring/50' : ''
                }`}
              >
                <CardHeader className="text-center pb-3 sm:pb-4 p-4 sm:p-6">
                  ...
                  {tier.popular && (
                    <Badge variant="secondary" className="mb-2 sm:mb-4 text-xs sm:text-sm bg-secondary text-white">
                      Más Popular
                    </Badge>
                  )}

                  <p className="text-muted-foreground text-xs sm:text-sm mb-3 sm:mb-4">{tier.description}</p>

                  <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-2">
                    ${tier.price.toFixed(2)}
                    <span className="text-sm sm:text-base lg:text-lg font-normal text-muted-foreground">/ticket</span>
                  </div>
                ...
                <CardContent className="p-4 sm:p-6 pt-0">
                  <Button
                    ...
                    className="w-full bg-primary text-white border-0 text-sm sm:text-base"
                  >
                    Elegir plan
                    <ChevronRight className="ml-2 h-4 w-4" />
                  </Button>
        ...
        <section className="mb-8 sm:mb-16">
          <Card className="backdrop-blur-md bg-card/40 border-border/50 p-4 sm:p-6 lg:p-8">
            <CardHeader className="text-center pb-4 sm:pb-6 p-0">
              ...
              <p className="text-muted-foreground text-sm sm:text-base">Sin importar el plan que elijas, tendrás acceso completo a todas nuestras funcionalidades</p>
            </CardHeader>

            <CardContent className="p-0">
              <div className="grid gap-3 sm:gap-4 sm:grid-cols-2 lg:grid-cols-4">
                {allFeatures.map((feature, index) => (
                  <div key={index} className="flex items-center p-3 sm:p-4 rounded-lg bg-secondary/50 border border-border/50 hover:bg-secondary/70 transition-colors">
        ...
        <section className="mb-8 sm:mb-16">
          <Card className="backdrop-blur-md bg-gradient-to-r from-blue-900/40 to-purple-900/40 border-primary/30 p-4 sm:p-6 lg:p-8 text-center">
            ...
            <CardContent className="p-0">
              <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
                {[
                  ...
                  <div key={index} className="p-4 sm:p-6 rounded-lg bg-secondary/50 border border-border/50 hover:bg-secondary/70 transition-colors">
      ...
      <footer className="backdrop-blur-md bg-background/80 border-t border-border/50 py-8 sm:py-12">
