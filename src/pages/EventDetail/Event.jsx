    ...
    <Card className="bg-card border-border mb-4">
      ...
      <CardHeader className="pb-0">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg overflow-hidden border border-border shrink-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground mt-0.5">
              <CalendarDaysIcon className="h-3 w-3 inline mr-1 text-primary" />{formatDate(event.date)}
      ...
      <CardContent className="py-3">
        <div className="grid grid-cols-2 gap-3 text-center">
          <div className="bg-background/40 rounded-md py-1.5 px-2">
            <p className="text-[10px] text-muted-foreground uppercase tracking-wide">Capacidad</p>
      ...
      <CardContent className="pt-0 pb-3">
        <div className="flex items-center justify-between mb-1.5">
          <span className="text-xs text-muted-foreground uppercase tracking-wide">Ingresaron</span>
          <span className="text-xs text-muted-foreground">{event.tickets_scanned} / {event.tickets_sold} · {percentage.toFixed(0)}%</span>
        </div>
