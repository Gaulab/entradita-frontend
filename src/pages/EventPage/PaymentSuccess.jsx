...
export default function PaymentSuccess() {
  ...
  return (
    <div className="min-h-screen bg-[#121a24] flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-[#1a2433] rounded-2xl shadow-2xl border border-border overflow-hidden text-center p-8 animate-in fade-in zoom-in duration-500">
        ...
        <div className="bg-[#121a24] rounded-lg p-4 text-left border border-border flex justify-between items-center">
          <p className="text-muted-foreground text-xs tracking-wider uppercase font-semibold">ID del pago</p>
        ...
        <div className="my-8 flex gap-2 text-lg items-center justify-center text-muted-foreground">
