...
const blockTypes = [
  ...
  { id: 'IMAGE', name: 'Block Image', icon: Eye },
  { id: 'COUNTDOWN', name: 'Block countdown', icon: BoxIcon },
        ...
        return (
          <div className="space-y-2">
            ...
            <div>
              ...
              <Input className="p-1.5" type="color" value={block.data.card_color || '#000000'} onChange={(e) => updateBlock(block.id, { data: { ...block.data, card_color: e.target.value } })} />
            </div>
            <div>
            ...
            <div>
              ...
              <Input className="p-1.5" type="color" value={block.data.font_color || '#FFFFFF'} onChange={(e) => updateBlock(block.id, { data: { ...block.data, font_color: e.target.value } })} />
            </div>
          </div>
        );
      case 'TITLE':
        ...
        return (
          <div className="space-y-2">
            ...
            <div>
              ...
              <Input type="color" value={block.data.button_bgcolor || '#FFFFFF'} onChange={(e) => updateBlock(block.id, { data: { ...block.data, button_bgcolor: e.target.value } })} />
            </div>
            <div>
              <h3 className="text-sm font-bold mb-1">Color de la letra</h3>
              <Input type="color" value={block.data.button_color || '#000000'} onChange={(e) => updateBlock(block.id, { data: { ...block.data, button_color: e.target.value } })} />
            </div>
          </div>
        );
      case 'PAY':
