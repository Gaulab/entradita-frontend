...
function Zoe2() {
  ...
  const eventLocation = ""
  const eventAddress = "FLa Rocka Discotheque, Malabrigo"
  ...
  return (
      ...
      {/* Header Section */}
        <section
          className="w-full max-w-xl bg-gradient-to-r from-purple-100 to-purple-200 py-10 text-center"
          style={{
          ...
          {/* Hero Image Section */}
      <section className="w-full max-w-xl py-2 md:py-16 bg-purple-50">
        <div className="container flex flex-col items-center px-2 md:px-0">
          <div className="relative h-[300px] w-full max-w-3xl overflow-hidden rounded-xl md:h-[400px]">
            <img
              src="Principal2.jpeg?text=Zoe's+15th+Birthday"
      ...
      {/* Countdown Section */}
      <section className="w-full max-w-xl bg-white py-12 md:py-16">
        <div className="container px-4 md:px-6">
      ...
      <section className="w-full max-w-xl py-4 md:py-16 bg-purple-50">
        <div className="container px-4 md:px-6">
      ...
      {/* Footer */}
      <footer className="w-full max-w-xl bg-purple-800 py-6 text-center text-white">
        <div className="container px-4 md:px-6">
